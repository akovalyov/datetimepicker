...
;(function (factory) {
    ...
    var default_options  = {
        ...
        todayButton: true,
        todayButtonContent: '<button type="button" class="xdsoft_today_button fa" type="Now"></button>',
        prevButton: true,
        nextButton: true,
        defaultSelect: true,
    ...
    $.fn.datetimepicker = function (opt, opt2) {
        ...
        createDateTimePicker = function (input) {
            var datetimepicker = $('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
                ...
                mounth_picker = $('<div class="xdsoft_mounthpicker"><button type="button" class="xdsoft_prev"></button>' +
                    options.todayButtonContent +
